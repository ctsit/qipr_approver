# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-17 20:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('big_aim', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='projects', to='approver.BigAim')),
                ('category', models.ManyToManyField(related_name='projects', to='approver.Category')),
                ('clinical_area', models.ManyToManyField(related_name='projects', to='approver.ClinicalArea')),
                ...
                ('created_by', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('last_modified_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('mesh_keyword', models.ManyToManyField(null=True, related_name='projects', to='approver.Descriptor')),
        ...
        migrations.AddField(
            model_name='person',
            name='self_classification',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='person', to='approver.Self_Classification'),
        ),
        migrations.AddField(
            model_name='person',
            name='speciality',
