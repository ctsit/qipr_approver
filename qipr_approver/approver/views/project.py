...
def project(request, project_id=None):
    ...
    if request.method == 'POST':
        ...
        if(project is None):
            ...
            if (project_crud.curent_user_is_project_owner(current_user, project) is True and project.get_is_editable() and not project.archived) or project_crud.current_user_is_superuser:
                project = project_crud.create_or_update_project(current_user, project_form, project_id)
            else:
