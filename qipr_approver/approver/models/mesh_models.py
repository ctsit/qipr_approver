...
class Descriptor(MeshModel):
    allowable_qualifiers = models.ManyToManyField(Qualifier, related_name='descriptors')
    descriptor_class = models.CharField(null=True, maxLength=1)
    descriptor_entry_version = models.CharField(null=True, maxLength=100)
    descriptor_sort_version = models.CharField(null=True, maxLength=300)
    major_descriptor_date = models.DateField(null=True)
    entry = models.ManyToManyField(Entry, related_name='descriptor')
    forward_reference = models.ManyToManyField('self', null=True)
    ...
    cas_registry_number = models.CharField(null=True, max_lenght=40)
